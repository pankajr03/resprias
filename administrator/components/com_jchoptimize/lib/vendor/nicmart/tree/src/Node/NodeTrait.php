...
namespace _JchOptimizeVendor\V91\Tree\Node;

use _JchOptimizeVendor\V91\Tree\Visitor\Visitor;
...
trait NodeTrait
{
    ...
    public function getNeighbors()
    {
        ...
        $current = $this;
        return \array_values(\array_filter($neighbors, static function ($item) use ($current) {
            return $item !== $current;
        }));
    }
