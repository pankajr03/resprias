 ...
 */
namespace _JchOptimizeVendor\V91\Symfony\Component\Process;

use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\InvalidArgumentException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\LogicException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\ProcessFailedException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\ProcessSignaledException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\ProcessTimedOutException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Exception\RuntimeException;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Pipes\PipesInterface;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Pipes\UnixPipes;
use _JchOptimizeVendor\V91\Symfony\Component\Process\Pipes\WindowsPipes;
...
class Process implements \IteratorAggregate
{
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('_JchOptimizeVendor\V91\proc_open')) {
    ...
    protected function isSigchildEnabled()
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('_JchOptimizeVendor\V91\phpinfo')) {
