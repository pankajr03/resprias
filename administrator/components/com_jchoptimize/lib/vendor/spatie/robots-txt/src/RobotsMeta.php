...
use _JchOptimizeVendor\V91\JetBrains\PhpStorm\ArrayShape;
...
class RobotsMeta
{
    ...
    protected function findRobotsMetaTagProperties(string $html): array
    {
        ...
        return ['noindex' => $metaTagLine ? strpos(strtolower($metaTagLine), 'noindex') !== \false : \false, 'nofollow' => $metaTagLine ? strpos(strtolower($metaTagLine), 'nofollow') !== \false : \false];
    }
