...
class Robots
{
    ...
    public function __construct(protected string|null $userAgent = null, RobotsTxt|string|null $source = null)
    {
    ...
    {
        $this->robotsTxt = $source instanceof RobotsTxt ? $source : RobotsTxt::readFrom($source);
        return $this;
    }
    ...
    public function mayIndex(string $url, string $userAgent = null): bool
    {
        ...
        return $robotsTxt->allows($url, $userAgent) && RobotsMeta::create($content)->mayIndex() && RobotsHeaders::create($http_response_header ?? [])->mayIndex();
    }
    public function mayFollowOn(string $url): bool
    {
        ...
        return RobotsMeta::create($content)->mayFollow() && RobotsHeaders::create($http_response_header ?? [])->mayFollow();
    }
