...
class ServiceManager implements ServiceLocatorInterface
{
    ...
    private function assertCallableDelegatorFactory($delegatorFactory): void
    {
        ...
        throw new ServiceNotCreatedException(sprintf('A non-callable delegator, "%s", was provided; expected a callable or instance of "%s"', is_object($delegatorFactory) ? $delegatorFactory::class : gettype($delegatorFactory), DelegatorFactoryInterface::class));
    }
}
