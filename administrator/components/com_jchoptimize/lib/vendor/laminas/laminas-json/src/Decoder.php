...
class Decoder
{
    ...
    protected function __construct($source, $decodeType)
    {
        ...
        $this->decodeType = match ($decodeType) {
            ...
            default => throw new InvalidArgumentException(sprintf('Unknown decode type "%s", please use one of the Json::TYPE_* constants', $decodeType)),
        };
    ...
    protected static function utf162utf8($utf16)
    {
        ...
        return match (\true) {
            ...
            // see: http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
            (0x7ff & $bytes) === $bytes => chr(0xc0 | $bytes >> 6 & 0x1f) . chr(0x80 | $bytes & 0x3f),
            // Return a 3-byte UTF-8 character;
            // see: http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
            (0xffff & $bytes) === $bytes => chr(0xe0 | $bytes >> 12 & 0xf) . chr(0x80 | $bytes >> 6 & 0x3f) . chr(0x80 | $bytes & 0x3f),
