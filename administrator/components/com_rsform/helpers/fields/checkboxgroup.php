...
class RSFormProFieldCheckboxGroup extends RSFormProFieldMultiple
{
	...
	public function getFormInput() {
		...
		$output = '<fieldset class="rsfp-fieldset"><legend class="rsfp-visually-hidden">' . $this->escape($this->getProperty('CAPTION'))  . '</legend>' . $output . '</fieldset>';
	...
	public function getAttributes()
	{
		...
		// This isn't allowed on checkboxes
