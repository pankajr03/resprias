...
function __construct()
{
	...
	$this->skipDirs[] = rtrim(Factory::getApplication()->getConfig()->get('tmp_path', JPATH_ROOT.'/tmp'), '/');
	$this->skipDirs[] = rtrim(Factory::getApplication()->getConfig()->get('log_path', JPATH_ROOT.'/logs'), '/');
