    ...
    <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->catid?>">
        ...
        <td>     
            ...
            <?php if ($canEdit || $canEditOwn) : ?>
                    <a href="<?php echo Route::_('index.php?option=com_zhgooglemap&task=mapoverride.edit&id=' . $item->id); ?>">
            ...
            <span class="zhgm-form-item-tv-label">
                <?php echo HTMLHelper::_('searchtools.sort', 'COM_ZHGOOGLEMAP_MAPOVERRIDE_HEADING_CATEGORY', 'category_title', $listDirn, $listOrder) . ": ";?>
            </span>
        ...
        <td align="center">
            <?php 
                echo HTMLHelper::_('jgrid.published', $item->published, $i, 'mapoverrides.', $canChange, 'cb', $item->publish_up, $item->publish_down); 
