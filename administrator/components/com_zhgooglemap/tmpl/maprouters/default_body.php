    ...
    <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->catid?>">
        ...
        <td>     
            ...
            <?php if ($canEdit || $canEditOwn) : ?>
                    <a href="<?php echo Route::_('index.php?option=com_zhgooglemap&task=maprouter.edit&id=' . $item->id); ?>">
            ...
            <span class="zhgm-form-item-tv-label">
                <?php echo Text::_('COM_ZHGOOGLEMAP_MAPROUTER_HEADING_MAPTITLE') . ": "; ?>
            </span>
            ...
            <div>
            <span class="zhgm-form-item-tv-label">
                <?php echo HTMLHelper::_('searchtools.sort', 'COM_ZHGOOGLEMAP_MAPROUTER_HEADING_CATEGORY', 'category_title', $listDirn, $listOrder) . ": ";?>
            </span>
            <span class="zhgm-form-item-tv-value">
            <?php 
        ...
        <td align="center">
            <?php 
                echo HTMLHelper::_('jgrid.published', $item->published, $i, 'maprouters.', $canChange, 'cb', $item->publish_up, $item->publish_down); 
