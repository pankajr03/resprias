 ...
 * Model
 */
class MaproutersModel extends ListModel
{
    ...
    protected function getListQuery() 
    {
        ...
        $query->select('h.id,h.title,h.mapid,h.published,h.publish_up,h.publish_down,h.catid,c.title as category, c.language as category_language,m.title as mapname');
        $query->from('#__zhgooglemaps_routers as h');
