 ...
 * Model
 */
class MapmarkergroupsModel extends ListModel
{
    ...
    protected function getListQuery() 
    {
        ...
        $query->select('h.id,h.title,h.published,h.publish_up,h.publish_down,h.catid,h.icontype,h.ordering,h.userorder,c.title as category, c.language as category_language');
