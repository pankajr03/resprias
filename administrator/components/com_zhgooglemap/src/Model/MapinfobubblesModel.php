 ...
 * Model
 */
class MapinfobubblesModel extends ListModel
{
    ...
    protected function getListQuery() 
    {
        ...
        $query->select('h.id,h.title,h.published,h.publish_up,h.publish_down,h.catid,c.title as category, c.language as category_language');
        $query->from('#__zhgooglemaps_infobubbles as h');
