 ...
 * Model
 */
class MapoverridesModel extends ListModel
{
    ...
    protected function getListQuery() 
    {
        ...
        $query->select('h.id,h.title,h.published,h.publish_up,h.publish_down,h.catid,h.ordering,c.title as category, c.language as category_language');
        $query->from('#__zhgooglemaps_text_overrides as h');
