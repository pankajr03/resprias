...
class MapoverrideField extends ListField
{
    /**
     * The field type.
     *
    ...
    protected function getOptions() 
    {
        ...
        //array_unshift($options, HTMLHelper::_('select.option', '', Text::_( 'COM_ZHGOOGLEMAP_MAPOVERRIDE_FILTER_MAP')));
