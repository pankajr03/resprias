...
class MapmapField extends ListField
{
    /**
     * The field type.
     *
    ...
    protected function getOptions() 
    {
        ...
        $query->from('#__zhgooglemaps_maps as h');
        ...
        //array_unshift($options, HTMLHelper::_('select.option', '', Text::_( 'COM_ZHGOOGLEMAP_MAP_FILTER_MAP')));
