...
-------------------------------------------------------------------------*/
namespace ZhukDL\Component\ZhGoogleMap\Administrator\View\Mapmap;
...
use ZhukDL\Component\ZhGoogleMap\Administrator\Model\MapmapModel;
...
class HtmlView extends BaseHTMLView
{
    ...
    protected function addToolBar() 
    {
        ...
        ToolBarHelper::title($isNew ? Text::_('COM_ZHGOOGLEMAP_MAP_NEW') : Text::_('COM_ZHGOOGLEMAP_MAP_EDIT'), 'mapmap');
        ...
        if ($isNew) 
        {
            ...
            {
                $toolbar->apply('mapmap.apply');
                $toolbarButtons[] = ['save', 'mapmap.save'];
                $toolbarButtons[] = ['save2new', 'mapmap.save2new'];
            }
        }
        else
        {
            ...
            if ($canDo->get('core.create')) 
            {
                $toolbarButtons[] = ['save2copy', 'mapmap.save2copy'];
            }
        }
        ...
        $toolbar->cancel('mapmap.cancel');
        
        $help_url = 'http://wiki.zhuk.cc/index.php/Zh_GoogleMap_Description#Creating_Map';
    ...
    protected function setDocument() 
    {
        ...
        $document->setTitle($isNew ? Text::_('COM_ZHGOOGLEMAP_ADMINISTRATION_MAP_CREATING') : Text::_('COM_ZHGOOGLEMAP_ADMINISTRATION_MAP_EDITING'));
    }
	*/
}
