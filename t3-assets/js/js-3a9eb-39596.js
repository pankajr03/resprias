...
/*===============================
/templates/ja_mason/js/custom.js
================================================================================*/;
$(document).ready(function(){var owl=$('.owl-carousel');owl.owlCarousel({items:3,loop:true,nav:false,dots:true,dotsEach:true,responsive:{0:{items:1},768:{items:3}}});});jQuery(document).ready(function($){const items=$('.accordion button');function toggleAccordion(){const itemToggle=$(this).attr('aria-expanded');items.attr('aria-expanded','false');if(itemToggle==='false'){$(this).attr('aria-expanded','true');}}
