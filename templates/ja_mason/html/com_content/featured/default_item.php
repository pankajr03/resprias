...
?>
  ...
  <?php if ($this->item->state == 0 || strtotime($timePublishUp) > strtotime(Factory::getDate())
	|| ((strtotime($timePublishDown) < strtotime(Factory::getDate())) && $timePublishDown != Factory::getDbo()->getNullDate() )) : ?>
    ...
    <?php endif; ?>
		...
		<?php if ($params->get('show_readmore') && $this->item->readmore) :
			...
			<section class="readmore">
				<a class="btn btn-default btn-sp" href="<?php echo $link; ?>" itemprop="url">
					<span>
					...
					elseif ($params->get('show_readmore_title', 0) == 0) :
						echo Text::sprintf('TPL_CONTENT_READ_MORE_TITLE');
					else :
