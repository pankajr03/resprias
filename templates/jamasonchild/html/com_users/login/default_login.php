...
<div class="login-wrap">
  ...
  <div class="login <?php echo $this->pageclass_sfx; ?>">
        ...
        <div class="col-sm-12">
          <div class="checkbox">
            <label>
              ...
              <?php echo Text::_(version_compare(JVERSION, '3.0', 'ge') ? 'COM_USERS_LOGIN_REMEMBER_ME' : 'JGLOBAL_REMEMBER_ME') ?>
            </label>
          </div>
        </div>
      </div>
      <?php endif; ?>
  			...
  			<div class="form-group">
  				<div class="col-sm-12">
  					<button type="submit" class="btn btn-primary btn-lg btn-block"><?php echo JText::_('JLOGIN'); ?></button>
  				</div>
  			</div>
